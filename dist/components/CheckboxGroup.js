...
function CheckboxGroup(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var _loop = function _loop(i) {
      ...
      if (Object.values(trackers)[i] !== undefined) {
...
CheckboxGroup.propTypes = {
  ...
  trackers: _propTypes["default"].shape({
    personalization: _propTypes["default"].func,
    analytical: _propTypes["default"].func,
    marketing: _propTypes["default"].func,
    socialMedia: _propTypes["default"].func
  })
};