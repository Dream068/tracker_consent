...
export default function CheckboxGroup(props) {
  ...
  const handleChange = (event) => {
    ...
    switch (event.target.name) {
      case 'personalization': trackers.personalization(); break;
      case 'analytical': trackers.analytical(); break;
      case 'marketing': trackers.marketing(); break;
      case 'socialMedia': trackers.socialMedia(); break;
      default:
    }
  };
